  ...
  return (
    <div className="grid grid-cols-2 xl:grid-cols-3 mb-8 md:mb-20 gap-6 md:gap-20">
      ...
      <div className="w-full ">
        <FaGolang className="w-10 h-10 md:w-20 md:h-20 text-white mx-auto" />
        <p className="text text-center mt-1 md:mt-3">Go</p>
      </div>
      ...
      <div className="w-full ">
        <SiGnubash className="w-10 h-10 md:w-20 md:h-20 text-white mx-auto" />
        <p className="text text-center mt-1 md:mt-3">Bash</p>
      </div>
